...
| cluster_service_ipv4_cidr                 | Kubernetes service ipV4 CIDR                                                                                                                           | `172.20.0.0/32`       |    no    |
...
| ssh\_to\_nodes\_allowed\_cidr\_blocks     | CIDR blocks allowed to connect to EKS workers via ssh                                                                                                  | `null`                |    no    |
